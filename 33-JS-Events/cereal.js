...
function ourMapCallback(cereal) {
  return cereal.name
}

const newArray = cerealData.map(ourMapCallback)

// const newArray = cerealData.map(function(cereal){return cereal.name})


const newArray = cerealData.find(cereal => cereal.calories === 110)
//
// console.log(newArray)
/*

  find(func){
    loop(the array it's call off of){
      func(  cereal  ) //if we get a return true
    }
  }
*/
