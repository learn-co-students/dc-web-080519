...
## User Stories
- When a user clicks the dropdown menu, it should change the filters: type state in App
- When a user clicks Find Pets, "pets" state should change in App
    - all pets of that type should be displayed in PetBrowser
- When a user clicks "adopt" on the pet card, it should change that pet's "isAdopted" status in the app's state