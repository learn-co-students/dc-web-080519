...
X When the page loads, I should be able to see all pokemon
X When I double click on a PokemonCard in the bottom, it adds to my team
X When I double click on a pokemonCard in the top, I remove from my team
-XWhen I single click any pokemon card, I can see their stats
